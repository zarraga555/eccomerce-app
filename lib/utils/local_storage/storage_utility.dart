...
class EccomerceLocalStorage {
  static final EccomerceLocalStorage _instance = EccomerceLocalStorage._internal();

  factory EccomerceLocalStorage() {
    return _instance;
  }

  EccomerceLocalStorage._internal();
